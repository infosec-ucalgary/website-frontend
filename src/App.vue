  ...
  <div class="relative w-full" id="outer-container">
    ...
    <div class="text-center py-4 lg:px-4" id="upcoming-alert">
      <div class="p-2 bg-accent-2 items-center leading-none lg:rounded-full flex lg:inline-flex" role="alert">
        ...
        <span class="font-body mr-2 text-left flex-auto" style="font-color: #12418f;">Join our <a href="https://discord.gg/wVwv5Pw">Discord</a> to learn about meetings. Need to download Kali? Click <a href="https://kali.org/downloads/">here</a>!</span>
